...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        """
        Get a page from the indexed dataset along with pagination details.
        ...
        """
        assert index is not None and isinstance(index, int) and index >= 0, "index must be a non-negative integer"
